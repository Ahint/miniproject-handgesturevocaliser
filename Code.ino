...
void loop()
{
 ...
 Serial.print("-");
  ...
  if(flex1>52)
  {
   ...
   else if(normAccel.YAxis>5){Serial.println("What's up");}
  ...
  /*else if(flex2>38)
  {
   ...
   else if(normAccel.XAxis<-3){Serial.println("Hii");}
   else if(normAccel.YAxis>3){Serial.println("MEDICINE");}
   else if(normAccel.YAxis<-3){Serial.println("byee");}
  }*/
  
  else if(flex3>53)
  {
   //Serial.println(flex3>53);
   digitalWrite(ledd,HIGH);
   if(normAccel.XAxis>5){Serial.println("My name is Shree");}
   else if(normAccel.XAxis<-5){Serial.println("WATER");}
   else if(normAccel.YAxis>5){Serial.println("Hello");}
   else if(normAccel.YAxis<-5){Serial.println("good morning");}
  }
}